  ...
  render() {
    ...
    return (
      <div className="container mt-5 col-lg-8 col-xl-7 text-center">
        ...
        <div className="mt-5 mb-2"><h1 className="h3">Register 
          <i className="fas fa-user-plus"></i></h1>
        </div>
          ...
          <form action="/register" method="POST" id="register-form">   
            ...
            </div>
            {
              (this.state.passCheck == false) ? 
                  <div className="alert alert-danger alert-dismissible show"  id="reqs" role="alert">
                    <strong>Error:</strong> Password does not contain all necessary characters or length 
                    requirements!
                  </div>
            ...
            <div className="form-group">
              ...
              <input type="text" name="username" id="username" onChange = {(event) => 
                this.setState({username:event.target.value})}  className="form-control" 
            ...
            <div className="form-row form-group">
              <div className="col">
                ...
                <input type="text" name="fname" id="fname" onChange = {(event) => 
                  this.setState({fname:event.target.value})}  className="form-control" 
                  placeholder="First Name" required />
              </div>
              <div className="col">
                <label className="sr-only" for="lname">Last Name</label>
                <input type="text" name="lname" id="lname" onChange = {(event) => 
                  this.setState({lname:event.target.value})}  className="form-control" 
            ...
            <div className="form-group">
              ...
              <input type="email" name="email" onChange = {(event) => 
                this.setState({email:event.target.value})}  id="email-address" className="form-control" 
                placeholder="Email" required />
            </div>
            <div className="form-group">
              <label className="sr-only" for="password">Password</label>
              <input type="password" name="password" id="pwd" onBlur = {(event) => 
                this.validatePassword(event.target.value)}  className={
            ...
            <div>
              ...
              <input type="password" name="confirm" id="confirm" onBlur = {(event) => 
                this.confirmPassword(event.target.value)}  className={
            ...
            <button className="btn btn-lg btn-danger btn-block mt-2" onClick={(event) => 
              this.doRegister(event)} type="button"  id="submit">Sign-up 
